...
const TransportTab = ({ transport }) => {
	...
	return (
		<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="!space-y-4 !p-1">
			<span className="text-lg font-semibold">Transport Details</span>
			{hasTransportDetails ? (
				<div className="!space-y-1 bg-gray-50 !py-2 rounded-lg">
